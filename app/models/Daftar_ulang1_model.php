<?php
	...
	class daftar_ulang1_model extends CI_Model{

		private $hasil_id,$id_pendaftaran,$jalur_id,$sekolah_id,$tipe_sekolah_id,$kompetensi_id,$user,$created_time;

		const pkey = "hasil_id";
		const tbl_name = "daftar_ulang1";
