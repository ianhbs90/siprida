...
<div id="main" role="main">
	...
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>Home</li><li>Administrasi</li><li>Sekolah</li>
		</ol>
	</div>
	<!-- END RIBBON -->
					...
					<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">
						...
						<div>
							...
							<div class="widget-body">
								...
								<form class="form-horizontal" id="<?=$form_id;?>" action="<?=base_url().$active_controller.'/search_school_data';?>" method="POST">
...
<script type="text/javascript">	
    ...
    function load_form(id){
        ...
        ajax_object.set_url(base_url+'administration/load_school_form').set_id_input(id).set_input_ajax('ajax-req-dt').set_data_ajax(data_ajax).set_loading('#form-loader').set_content('#form-content').request_ajax();
	}

	function delete_record(id){
		ajax_object.reset_object();
        ajax_object.set_plugin_datatable(true).set_url(base_url+'administration/delete_school_data').set_id_input(id).set_input_ajax('ajax-req-dt').set_data_ajax()
