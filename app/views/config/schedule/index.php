...
<div id="main" role="main">
	...
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>Home</li><li>Pengaturan</li><li>Jadwal</li>
		</ol>
	</div>
	<!-- END RIBBON -->
					...
					<div class="jarviswidget" id="wid-id-7" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
						...
						<header>
							...
							<ul class="nav nav-tabs pull-left in">
								...
								<li>
									<a data-toggle="tab" href="#hr2"> Kegiatan </span></a>
								</li>
...
<script type="text/javascript">		
    ...
    function load_content(){
        ...
        ajax_object.set_n_req(2)        		   
        		   .set_url([base_url+'config/load_schedule1',base_url+'config/load_schedule2'])
	...
	function load_form(id){
		ajax_object.reset_object();
        ajax_object.set_url(base_url+'config/load_schedule_form').set_id_input(id).set_input_ajax('ajax-req-dt').set_data_ajax().set_loading('#form-loader').set_content('#form-content').request_ajax();
	}

	function delete_record(id,schedule_seq){
		ajax_object.reset_object();
        ajax_object.set_url(base_url+'config/delete_schedule_data').set_id_input(id).set_input_ajax('ajax-req-dt').set_data_ajax()
        		   .set_loading('#preloadAnimation').set_content('#list_schedule2_'+schedule_seq).update_ajax('menghapus data');
	}
