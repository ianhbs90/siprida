...
<div id="main" role="main">
	...
	<div id="ribbon">		
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>Monitoring</li><li>Verifikasi</li>
		</ol>
	</div>
	<!-- END RIBBON -->
...
<script type="text/javascript">	
	...
	function load_content(){
		...
		for(i=1;i<=n;i++)
		{
			...
			_data_ajax = ['jalur_id='+$('#jalur_id'+i).val(),'status=2','i='+i];
    ...
    {    	
        ...
        _si=setInterval(function(){
            $.ajax({
                ...
                data:'curr_counter='+$counter.html()+'&jalur_id='+$jalur_id.val()+'&status=2',
                beforeSend:function(){
                },
                complete:function(){
                },
